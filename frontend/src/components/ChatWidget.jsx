...
const ChatWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat Modal */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 bg-white rounded-lg shadow-xl border max-w-sm w-full">
          <div className="p-4">
            ...
            <p className="text-gray-600 mb-4">
              ¡Hola! Estamos aquí para ayudarte. Contáctanos por WhatsApp para una atención personalizada.
            </p>
